# Tutorial video harness — hira

Regenerates the screen-recorded tutorial (`hira.mp4`) by driving the **real app**
...
The tutorial uses on-screen **closed-caption text** (no audio). See `SCRIPT.md`
for the full caption text per scene.
...
```
The video is written to `demo/out/hira.mp4`.
