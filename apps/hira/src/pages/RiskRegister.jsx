            ...
            return (
              ...
              >
                ...
                <div className="mt-3 flex flex-wrap justify-end gap-2">
                  <Link to={`/apps/hira/create/${r.assessmentId}`} className="btn-ghost"><Wrench size={15} /> Add additional controls</Link>
                  <Link to={`/apps/hira/create/${r.assessmentId}`} className="btn-ghost"><Pencil size={15} /> Edit / add action</Link>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-ink-100">
                {rows.map((r, i) => (
                  <tr key={`${r.assessmentId}-${r.hazard.id}-${i}`} className="cursor-pointer transition hover:bg-clay-100/40" onClick={() => navigate(`/apps/hira/assessment/${r.assessmentId}`)}>
