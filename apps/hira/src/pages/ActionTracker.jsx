                ...
                {rows.map((r, i) => {
                  ...
                  return (
                    <tr key={`${r.assessmentId}-${r.control.id}-${i}`} className={overdue ? 'bg-red-50/60' : ''}>
                      ...
                      <td className="px-3 py-2">
                        <Link to={`/apps/hira/assessment/${r.assessmentId}`} className="font-semibold text-brand-600 hover:underline">
                          {r.assessmentName}
                        </Link>
                      ...
                      <td className="px-3 py-2 text-right">
                        <Link to={`/apps/hira/create/${r.assessmentId}`} className="rounded-lg p-1.5 text-ink-400 shadow-clay-sm transition hover:bg-clay-100 hover:text-ink-700" title="Edit assessment"><ExternalLink size={14} /></Link>
                      </td>
                    </tr>
                  )
                })}
