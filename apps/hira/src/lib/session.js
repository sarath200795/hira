...
// shared between the idle hook and the warning modal.
// ─────────────────────────────────────────────────────────────────────────────

// Auto sign-out after this much inactivity.
export const IDLE_MS = 15 * 60 * 1000 // 15 minutes
// Show the warning modal this long before sign-out.
export const WARN_MS = 60 * 1000 // 1 minute

/**
 * Decide the idle phase from the elapsed-since-last-activity. Pure + deterministic.
 ...
 * remainingMs = ms left until logout (clamped ≥ 0).
 */
...
/** Format milliseconds as m:ss (e.g. 60000 → "1:00", 5000 → "0:05"). */
