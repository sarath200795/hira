...
function systemPrompt(context) {
  return [
    ...
    'If the question is general safety / risk-assessment / control-measure / hazard',
    'guidance (not about the user\'s specific data), give a brief, practical, correct',
    'answer AND cite the UK HSE with the URL https://www.hse.gov.uk/.',
    '',
    'DATA (JSON):',
